// ═══════════════════════════════════════════════════════════════════
// TradeForge OS v10.6 — Trade Entry Bar
...
export default function TradeEntryBar() {
  const {
    tradeMode, tradeStep, tradeSide,
    pendingEntry, pendingSL, pendingTP,
    setTradeSide, exitTradeMode,
    riskAmount,
  } = useChartTradeStore();
  ...
  return (
    <div style={{
      ...
      {/* Level readouts */}
      <LevelChip label="E" value={pendingEntry?.price} color="#3b82f6" />
      ...
      {pos?.shares > 0 && (
        <span style={{
          fontSize: 9, fontWeight: 600, fontFamily: M, color: C.t2,
        }}>
      ...
      <button className="tf-btn"
        ...
        style={{
          ...
          borderRadius: 4, border: `1px solid ${C.r}30`,
